import { AlertTriangle, Ban, Banknote, BarChart2, BookOpen, Briefcase, Building2, CalendarDays, CheckSquare, ClipboardList, Contact, CreditCard, Disc3, FileBarChart, FileSignature, FileSpreadsheet, FileText, FolderOpen, Landmark, Layers, LayoutDashboard, Library, LineChart, Link2, Megaphone, MessagesSquare, Music, Package, PiggyBank, PlusCircle, Receipt, RefreshCw, Repeat, Scale, ScrollText, Target, SearchCheck, Send, Settings, ShieldCheck, TrendingUp, Upload, UserCheck, Users, Wallet, Wrench, Image } from 'lucide-react'
      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            { path: '/brand',                   label: 'Brand',        icon: Image, synonyms: 'brand logo logos photos press kit assets artwork download' },
          ],
        },
      ]
    },
