// ── /admin/vendor-lab — the vendor form, safe to break ───────────────────────
//
...
export default function VendorSubmitLab() {
  ...
  const handleSubmit = async e => {
    ...
    setSubmitting(true)
    try {
      // ?sandbox=1 — every validation the real submission runs, and then nothing
  ...
  // Always on here. In VendorSubmit this is gated because a real vendor must
  ...
  return (
    <div className="ms-form min-h-screen bg-gray-100" data-step={step} style={{fontSize:14}}>
      ...
      {adminPreview && (
        <div className="bg-indigo-100 border-b-2 border-indigo-400 text-indigo-900 text-xs font-semibold py-2 px-5 flex items-center justify-center gap-4 flex-wrap">
          <span>
