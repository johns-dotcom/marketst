...
const api = {
  get(url) { calls.get.push(url); if (url === '/settings/me') return ok({ id: 1, name: 'John', tours_done: scenario() === 'fresh' ? {} : scenario() === 'user' ? { welcome: { version: '2026-09-19' } } : { welcome: { version: '2026-09-19' }, home: { version: '2000-01-01' } } }); return ok([]) },
